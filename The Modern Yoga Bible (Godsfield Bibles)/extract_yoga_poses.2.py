...
def parse_yoga_poses(text_content):
    ...
    # Split into pose sections based on lines starting with ☆
    pose_sections = []
    current_section = []
    for line in lines:
        ...
        if stripped_line.startswith('☆'):
            if current_section:
                pose_sections.append(current_section)
                current_section = []
    ...
    for section in pose_sections:
        ...
        for line in content_lines:
            ...
            processed_line = process_spaced_text(line)
